...
/**
 * CourseRoll holds a list of all studnets enrolled in a course
 * and has a parameter for the enrollment cap of the course
 * CourseRoll can enroll and drop students from a Course, check if a student can enroll, and return open seats in course
...
public class CourseRoll { 
	 ...
	 * Initializes list to an empty list with capacity of enrollmentCap and sets enrollmentCap to enrollmentCap
	...
	/**
	 * Sets enrollmentCap to enrollmentCap passed in if enrollmentCap is more than the
	 * minimum number of students that can be enrolled in a class, less than the maximum number of students
	 * that can be enrolled in class, and is greater than the number of students already in the class
	...
	/**
	 * Returns the number of seats open in the class, which is enrollmentCap minus the number
	...
	/**
	 * Checks if student can enroll in class and if they can, adds them to list of students in class
	 ...
	 * @return false if they can't enroll in class
	 * 			true if they can enroll in class
	 */
