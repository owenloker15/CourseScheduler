...
/**
 * RegistrationManager handles a StudentDirectory and a CourseCatalog and allows a Registrar and 
 * a Student to be logged in in order to manage schedules.
...
public class RegistrationManager {
	...
	/**
	 * Returns the current singleton instance of RegistrationManager. Creates a new instance 
	 * if instance is null
	 * @return instance
	 */
	 ...
	 * @throws IllegalArgumentException if id or password is null or if a user with the given id does not exist
	 */
