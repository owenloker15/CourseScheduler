...
public class FacultyTest {
	...
	public void testEqualsObject() {
		...
		// Make sure that the Faculty objects with identical instance variables are equal.
	...
	public void testToString() {
		...
		assertEquals(FIRSTNAME + "," + LASTNAME + "," + ID + "," + EMAIL + "," + PASSWORD + ","  + MAXCOURSES, s.toString());
	...
	public void testHashCode() {
		...
		// Make sure that the Faculty objects with identical instance variables have same hash codes.
		assertEquals(s1.hashCode(), s2.hashCode());
		assertEquals(s4.hashCode(), s5.hashCode());
		
		// Ensure that Faculty objects with differing instance variables have different hash codes.
