...
public class CourseTest {
	...
	public void testSetName() {
		...
		// Testing valid names
		try {
			Course c1 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS,
					START_TIME, END_TIME);
			assertEquals("CSC216", c1.getName());

			Course c2 = new Course("E115", TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS,
					START_TIME, END_TIME);
			assertEquals("E115", c2.getName());

			Course c3 = new Course("MA141", TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS,
					START_TIME, END_TIME);
			assertEquals("MA141", c3.getName());

			Course c4 = new Course("HESF101", TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS,
					START_TIME, END_TIME);
			assertEquals("HESF101", c4.getName());

			Course c5 = new Course("CSC116", TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS,
					START_TIME, END_TIME);
		...
		c = null;
		try {
			c = new Course("E 11", TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS, START_TIME,
					END_TIME);
			fail();
		} catch (IllegalArgumentException e) {
			assertNull(c);
		...
		c = null;
		try {
			c = new Course("HESFQ101", TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS, START_TIME,
					END_TIME);
			fail();
		} catch (IllegalArgumentException e) {
			assertNull(c);
		...
		c = null;
		try {
			c = new Course("101", TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS, START_TIME,
					END_TIME);
			fail();
		} catch (IllegalArgumentException e) {
			assertNull(c);
		...
		c = null;
		try {
			c = new Course("HESF01", TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS, START_TIME,
					END_TIME);
			fail();
		} catch (IllegalArgumentException e) {
			assertNull(c);
	...
	public void testSetInstructorId() {
		...
		// Test that setting the instructor id to null is allowed
	...
	public void testSetMeetingDaysAndTimes() {
		...
		assertEquals(ENROLLMENT_CAP, c1.getCourseRoll().getEnrollmentCap());
		...
		assertEquals(ENROLLMENT_CAP, c2.getCourseRoll().getEnrollmentCap());
	...
	public void testCompareTo() {
		...
		Course c3 = new Course(NAME, TITLE, "002", CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS, START_TIME,
				END_TIME);
		Course c4 = new Course("CSC116", TITLE, "002", CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS, START_TIME,
				END_TIME);
		Course c5 = new Course("CSC316", TITLE, "004", CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS, START_TIME,
				END_TIME);
		Course c6 = new Course("CSC316", TITLE, "001", CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS, START_TIME,
				END_TIME);
		Course c7 = new Course("CSC316", TITLE, "001", CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS, START_TIME,
				END_TIME);
		...
		try {
			...
			assertEquals(c1.getSection(), SECTION);
			assertEquals(c1.getInstructorId(), INSTRUCTOR_ID);
			assertEquals(c1.getMeetingDays(), MEETING_DAYS);
			assertEquals(c1.getStartTime(), START_TIME);
			assertEquals(c1.getEndTime(), END_TIME);
		}

		// Test comparing two different Course names
		assertTrue(c1.compareTo(c4) > 0);
		assertTrue(c2.compareTo(c5) < 0);

		// Test comparing two different Course sections
